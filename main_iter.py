...
flags.DEFINE_integer('n_clusters', 10, 'Number of epochs to train.')    # this one can be calculated according to labels
...
flags.DEFINE_float("learn_rate_init_gen" , 1e-04, "the init of learn rate")
