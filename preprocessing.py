...
def get_target_nodes_and_comm_labels(target_str):
    ...
    #     if target.isdigit():
    #         tar_index = int(target)
    #         target_label = comm_labels[tar_index]
    #         out_label_list = np.zeros(len(comm_labels))
    #         out_label_list[comm_labels ==target_label ] =1
    #         out_dict[tar_index] = out_label_list
    return out_list
